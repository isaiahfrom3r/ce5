<?php if (!empty($_POST)): 
	...
	// Name of the file
$filename = 'dreamco.sql';

// Connect to MySQL server
$mysql_thing = mysqli_connect($mysql_host, $mysql_username, $mysql_password) or die('Error connecting to MySQL server: ' . mysqli_error());
// Select database
mysqli_select_db($mysql_thing,$_POST['dbName']) or die('Error selecting MySQL database: ' . mysqli_error($mysql_thing));
...
if (substr(trim($line), -1, 1) == '~')
{
    ...
    // Perform the query
    mysqli_query($mysql_thing,$templine) or die(print('Error performing query \'<strong>' . htmlspecialchars($templine) . '\': ' . mysqli_error() . '<br /><br />'));
...
$sql = "UPDATE ci_settings SET siteTitle='".$_POST['siteName']."' WHERE siteID=0";
...
<head>
<meta charset="utf-8">
<title>Install DreamCo CE5</title>
